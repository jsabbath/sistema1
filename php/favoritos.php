...
<body>
    ...
    <div id="cuerpo">
        <div id="catalago">
          <div id="tit">
            <h2 style="text-align: center; color: #ffffff;">Mis Favoritos</h2>
          </div>
          ...
          <div id="spr">
            ...
            <div id="todas">
                <?php
                    ...
                    $consulta = "select imagen from favoritos where cliente='$user'";
                    ...
                    while (!$ejecuta->EOF) {
                        ?>
                          <tr>
                           ...
                           <!--<img height="160" width="160" src="data:image/jpg;base64,<?php echo base64_encode($ejecuta->fields('imagen'));?>"/>-->
                           <td><img height="160" width="160" src="<?php echo $ejecuta->fields('imagen');?>"/></td> 
                          </tr>
                        <?php
                        $ejecuta->MoveNext();
                     }
