...
<body>
    ...
    <div id="cuerpo">
        ...
        <div id="fm1">
            <div id="tit">
                <h3 style="text-align: center;">Estado de Venta</h3>
             </div>
            <div id="objetos">
                <form>
                    <div id="o1">
                    ...
                    <div id="o8">
                        <label>Abono:</label>
                        <input type="text" maxlength="20" id="abno" disabled="disabled"/>
                    </div>
                    <div id="sub">
                        <input type="submit" value="<-- regresar" id="reg" name="volver"/>
                    </div>
                </form>
